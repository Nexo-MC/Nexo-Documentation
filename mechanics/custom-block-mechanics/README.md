...
The hitbox is not a normal 1x1x1 so it is advised to only use this for transparent block needs\
\
...
These can be found in \`MyServerFolder/config/paper-global.yml\`
{% endhint %}

{% hint style="warning" %}
Due to the nature of Custom Blocks, these for the most part completely disable the original block's vanilla functionality.\
