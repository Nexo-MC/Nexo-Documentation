...
**Glyphs** can be used via **%nexo\_glyphid%**, this will return the **\<glyph:glyphid>** for any Glyph not using the font _minecraft:default_ in its config. If one does, the raw unicode is returned.
